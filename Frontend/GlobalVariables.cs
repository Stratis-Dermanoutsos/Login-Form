...
namespace LoginForm.Frontend
{
    static class GlobalVariables
    {
        ...
        public static Color blueberry = Color.FromArgb(77, 100, 141); // Used for focused members
        public static Color periwinkle = Color.FromArgb(208, 225, 249); // Used for non-focused members
    }
}
